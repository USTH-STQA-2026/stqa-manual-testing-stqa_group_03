...
| **TC-06** | REQ-03 Search Books | Tìm `FLUTTER` ra kết quả giống chữ thường. | Hệ thống xử lý không phân biệt hoa/thường, hiển thị đúng sách. | **Pass** | `N/A` | `N/A` |
| **TC-07** | REQ-03 Search Books | Tìm kiếm với từ khóa có chứa khoảng trắng thừa ở 2 đầu vẫn ra đúng sách. | Hệ thống không báo "Không tìm thấy" mà bị lỗi hiển thị toàn bộ kho sách mặc định. | **Fail** | `image_0d9f83.png` | `BUG-REQ03-01` |
| **TC-08** | REQ-03 Filter Books | Thu hẹp danh sách bằng bộ lọc Thể loại "Công nghệ". | Hệ thống lọc chuẩn xác, chỉ hiển thị sách Công nghệ. | **Pass** | `N/A` | `N/A` |
| **TC-09** | REQ-03 Search & Filter| Lọc "Kinh tế" và kết hợp tìm kiếm "Flutter" (Logic AND). | Gõ ô tìm kiếm ghi đè và bỏ qua hoàn toàn điều kiện lọc Thể loại đang chọn. | **Fail** | `image_0da2e9.png` | `BUG-REQ03-02` |

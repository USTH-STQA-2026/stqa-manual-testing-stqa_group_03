...
| **TC-03-03** | REQ-03: Tìm kiếm & Lọc sách | Tìm kiếm theo tên tác giả hiển thị chính xác các cuốn sách của tác giả đó. | Hệ thống bóc tách dữ liệu và lọc ra đúng danh sách các cuốn sách thuộc về tác giả đã nhập. | **Pass** | <img width="3840" height="2256" alt="image" src="https://github.com/user-attachments/assets/9ca56b32-07d2-44e8-9e13-c0b84ef9f0fb" />| Không có |

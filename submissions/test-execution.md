...
| **TC-03-02** | REQ-03: Tìm kiếm & Lọc sách | Hệ thống xử lý không phân biệt hoa thường, tìm `"FLUTTER"` ra kết quả giống chữ thường. | Hệ thống không xử lý chuẩn hóa, báo trống `"Không tìm thấy sách"` (Bị lỗi phân biệt hoa/thường). | **Fail** | <img width="3840" height="2256" alt="image" src="https://github.com/user-attachments/assets/1e111118-81e4-4c11-a360-dd7a0b68162d" />| Không có |

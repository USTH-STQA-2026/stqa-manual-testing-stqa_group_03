...
| **TC-01-03** | REQ-01: Đăng nhập | Từ chối đăng nhập với email không tồn tại, báo lỗi "Không tìm thấy thành viên". | Hệ thống từ chối đăng nhập, hiển thị chính xác thông báo lỗi tài khoản không tồn tại. | **Pass** | ![Uploading image.png…]()| Không có |
...
| **TC-01-05** | REQ-01: Đăng nhập | Từ chối xử lý khi email sai định dạng (thiếu @ hoặc dấu .). | Giao diện chặn đăng nhập, báo lỗi định dạng email không hợp lệ. | **Pass** | <img src="image-5.png" width="150"> | Không có |
...
| **TC-07-01** | REQ-07: Quản lý thành viên | Thủ thư thêm thành viên mới thành công với email hợp lệ (binh.ly@email.com). | Hệ thống từ chối thêm mới và báo lỗi đỏ "Email không hợp lệ" dù email hoàn toàn đúng định dạng. | **Fail** | <img src="image-6.png" width="150"> | BUG-01 |
